<template>
    ...
    <div class="nav-container page-component">
      ...
      <div class="nav left-nav">
        ...
        <!-- <div class="nav-item selected">
          <span class="v-link selected dark" :onclick="'javascript:window.location=\'/hospital/1000_0'+'\''">预约挂号 </span>
        </div>
        <div class="nav-item ">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/detail/1000_0'+'\''"> 医院详情 </span>
        </div>
        <div class="nav-item">
          <span class="v-link clickable dark" :onclick="'javascript:window.location=\'/hospital/notice/1000_0'+'\''"> 预约须知 </span>
        </div> -->
  ...
  export default {
    ...
    created() {
      ...
      // console.log("hello there" + this.hoscode)
      this.init()
    },
